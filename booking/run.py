...
@last-modified Tue Jan 08 2019 20:55:12 GMT+0800 (CST)
"""
...
def run(train_date, train_name, seat_types, from_station, to_station, pay_channel=BANK_ID_WX, **kwargs):
    ...
    assert isinstance(seat_types, (list, tuple)), 'Invalid seat_types param. %s' % seat_types
    ...
    while True:
        try:
            ...
            if booking_status == BOOKING_STATUS_QUERY_LEFT_TICKET:
                train_info = query_left_tickets(train_date, from_station, to_station, seat_types)
